...
export default function HomeScreen(){
    return (
        <div className="grid h-screen min-h-[700px] grid-cols-12 grid-rows-10 gap-4 p-4 max-lg:h-auto max-lg:grid-rows-none max-lg:py-6 transition-all duration-300 ease-in-out">
            ...
            <div className="col-span-2 row-span-5 min-h-[288px] max-lg:col-span-3 max-md:col-span-full"><Spotify /></div>
            <div className="col-span-4 row-span-5 min-h-[288px] max-lg:col-span-6 max-md:col-span-full"><AboutMe /></div>
            <div className="col-span-2 row-span-5 min-h-[288px] max-lg:col-span-6 max-md:col-span-full"><ContactMe /></div>
            </div>
            ...
            <div className="col-span-4 row-span-8 max-lg:col-span-full"><Projects /></div>
